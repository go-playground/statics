...
func TestMain(m *testing.M) {
	...
	// setup
	// cmd := exec.Command("go", "build", "-o", "run")
	// err := cmd.Run()
	// if err != nil {
	// 	log.Fatal(err)
	// }
...
// 	PanicMatches(t, func() { main() }, "runtime error: invalid memory address or nil pointer dereference")
// }
...
func TestGenerateFile(t *testing.T) {
	...
	// _, err := ioutil.ReadFile("static/test-files/test.go")
	// Equal(t, err, nil)
